...
.animation{
 margin-top: 70px;
  ...
  justify-content: center; /* Agar elemen di dalamnya rata tengah */
  margin-bottom: 40px;
}
.one, .two, .three {
	display:block;
...
/* Tambahan agar tombol berada di tengah */
h2 + .btn-home {
  display: block;
  text-align: center;
...
<h2 class="uppercase">This Page is Under Construction</h2> 
<h2 class="uppercase">Halaman Ini sedang Di Pebaikan</h2> 
<h2 class="uppercase">Halaman Ieu Nuju Di Dangdosan</h2> 
<h2 class="uppercase">このページは建設中です</h2>
