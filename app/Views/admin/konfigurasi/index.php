...
<div class="form-group row">
	...
	<div class="col-6">
		...
		<small class="text-warning">Format nomor: 6281000000</small>
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-6">
		<input type="text" name="tiktok" class="form-control" value="<?php echo $konfigurasi->tiktok ?>">
		<small class="text-secondary">Alamat link akun</small>
	</div>
</div>

<div class="form-group row">
	<label class="col-3">X <i class="fab fa-twitter"></i></label>
	<div class="col-3">
