  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y') ?> <a href="https://adminlte.io">SMK Negeri 1 Buahdua (AdminLTE.io) </a>.</strong> All rights reserved  | Versi Framework: <?= CodeIgniter\CodeIgniter::CI_VERSION ?>
  </footer>
